...
namespace EMY.Restaurant.Presentation.Web.Controllers
{
    ...
    public partial class AdminController : Controller
    {
        ...
        public async Task<IActionResult> SaveCategory(string menuCategoryID, string name, string description, IFormFile headerPhoto, IFormFile logoPhoto, int index)
        {
        ...
        public async Task<IActionResult> SaveMenu(Menu menu, IFormFile photoContent)
        {
            ...
            else
            {
                ...
                currentMenu.ShowInHomePage = menu.ShowInHomePage;
                if (photoContent != null)
                {
        ...
        public async Task<IActionResult> SaveSubCategory(string menuCategoryID, string masterMenuCategoryID, string name, string description, int index, IFormFile logoPhoto, IFormFile headerPhoto)
        {
            ...
            if (menuCategoryID.ToGuid() != Guid.Empty)
            {
                ...
                if (logoPhoto != null)
                {
                    currentCategory.LogoPhotoID = LogoPhotoID;
                    currentCategory.LogoPhotoURL = LogoPhotoUrl;
                }
